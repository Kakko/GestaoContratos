			...
			<tbody>
				<?php foreach($get_systems as $s): ?>
					<tr style="font-size: 12px">
						...
						<td style="width: 15%">
							<button class="btn btn-outline-warning btn-sm" onclick="editar_sistema(<?php echo $s['id']; ?>)"><i class="fas fa-pen"></i></button>
							<button class="btn btn-outline-danger btn-sm" onclick="excluir_sistema(<?php echo $s['id']; ?>)"><i class="fas fa-trash"></i></button>
						</td>
					</tr>
				<?php endforeach; ?>
			</tbody>
