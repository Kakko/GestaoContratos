...
class relatoriosController extends Controller {
    ...
    public function rel_licitacoes(){
        ...
        if(in_array('17', $permissions->verifySystemPermissions())) {
    ...
    public function rel_contratos(){
        ...
        if(in_array('22', $permissions->verifySystemPermissions())) {
    ...
    public function rel_faturas(){
        ...
        if(in_array('23', $permissions->verifySystemPermissions())) {
    ...
    public function rel_geral() {
        ...
        if(in_array('24', $permissions->verifySystemPermissions())) {
