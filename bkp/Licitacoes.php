            ...
            <table class="table table-striped table-hover table-sm" id="table_licitacoes">
                ...
                foreach($listar_licitacoes as $d){
                    ...
                    <tbody style="font-size: 12px">';
                        ...
                        <td>
                            <button class="btn btn-outline-info btn-sm" onclick="ver_licitacao('.$d['id'].')"><i class="fas fa-eye"></i></button>
                            <button class="btn btn-outline-primary btn-sm" onclick="cad_historico('.$d['id'].')"><i class="fas fa-history"></i></button>
                            <button class="btn btn-outline-success btn-sm" onclick="cad_desconto('.$d['id'].')"><i class="fas fa-percent"></i></button>
                            <button class="btn btn-outline-warning btn-sm" onclick="editar_licitacao('.$d['id'].')"><i class="fas fa-pen"></i></button>
                            <button class="btn btn-outline-note btn-sm" onclick="addNote('.$d['id'].')"><i class="far fa-sticky-note"></i></button>
                            <button class="btn btn-outline-danger btn-sm" onclick="excluir_licitacao('.$d['id'].')"><i class="fas fa-trash"></i></button>
                        </td>
                    </tr>
                </tbody>
            ';
